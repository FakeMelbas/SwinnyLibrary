...
ALTER TABLE [dbo].[Author] ALTER COLUMN [AuthorLastName] NVARCHAR (50) NOT NULL;
...
GO
ALTER TABLE [dbo].[Student] ALTER COLUMN [Email] NVARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[Student] ALTER COLUMN [FirstName] NVARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[Student] ALTER COLUMN [LastName] NVARCHAR (50) NOT NULL;
